...
describe('ChatService - Get Chat History', () => {
  ...
  it('should return chat history in chronological order', async () => {
    ...
    const mockGetChatHistory = chatRepository.getChatHistory as jest.MockedFunction<typeof chatRepository.getChatHistory>;
...
describe('ChatService - Delete Chat History', () => {
  ...
  it('should delete chat history and return count', async () => {
    ...
    const mockDeleteChatHistory = chatRepository.deleteChatHistory as jest.MockedFunction<typeof chatRepository.deleteChatHistory>;
